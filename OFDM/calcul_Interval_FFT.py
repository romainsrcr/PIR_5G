...
if (SampleParFrame % 10 != 0):
	...
	print("removePilot = [",1,":",int(intervalExtrem)," ",int(intervalExtrem+2),":",int(intervalExtrem+IntervalBase+1)," ",int(intervalExtrem+IntervalBase+3),":",int(intervalExtrem+2*IntervalBase+2)," ",int(intervalExtrem+2*IntervalBase+4),":",int(intervalExtrem+3*IntervalBase+5)," ",int(intervalExtrem+3*IntervalBase+7),":",int(intervalExtrem+5*IntervalBase+3)," ",int(intervalExtrem+5*IntervalBase+5),":",int(intervalExtrem+6*IntervalBase+4)," ",int(intervalExtrem+6*IntervalBase+6),":",int(intervalExtrem+7*IntervalBase+5)," ",int(intervalExtrem+7*IntervalBase+7),":",int(intervalExtrem+8*IntervalBase+6)," ",int(intervalExtrem+8*IntervalBase+8),":",int(2*intervalExtrem+8*IntervalBase+8),"]")
else:
	print("1 OK on est troooop fort")